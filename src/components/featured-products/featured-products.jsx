import "../featured-products/featured-products.css";
...
function FeaturedProducts() {
    ...
    const allElectroProducts = allProducts.filter((product) => product.tags.includes("electronics")).sort((a, b) => b.price - a.price).slice(0, 10);
